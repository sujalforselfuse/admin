...
const errorToast = (msg) => toast.error(msg, {
  ...
  return (
    <div className='px-4 mt-2 mb-6 flex flex-col'>
      <ToastContainer />
      <h1 className='text-2xl font-bold mb-2 '>View Orders</h1>
      {/* {
        orders.map((order) => (
          <div key={order._id} className='bg-white border-2 border-[#006400] rounded-lg p-2 py-3 my-2 grid grid-cols-5'>
            ...
            <span className='text-sm font-semibold'>{order.amountAfterDiscount}</span>
            <Link to={`/order/${order._id}`} className='text-sm font-bold underline text-blue-600'>View More</Link>
