...
export default function EmployLogin() {
    ...
    const handleSubmit = async (e) => {
        setLoading(true);
        const res = await fetch(`https://ratna-backend-smp.onrender.com/api/employ/login`, {
            method: 'POST',
            headers: {
        ...
        if (data.success) {
            ...
            localStorage.setItem('ratnaemploytoken', data.token);
            localStorage.removeItem('ratnatoken');
    ...
    return (
        <div>
            ...
            <div class="h-screen py-40" style={{ "background-image": "linear-gradient(115deg, #9F7AEA, #FEE2FE)" }}>
                <div class="container mx-auto">
                    ...
                    <div class="flex flex-col lg:flex-row w-10/12 lg:w-8/12 bg-white rounded-xl mx-auto shadow-lg overflow-hidden">
                        ...
                        <div class="w-full lg:w-1/2 py-16 px-12">
                            <h2 class="text-3xl mb-4 font-semibold">Employ Login</h2>
                            ...
                            <div class="mt-5">
                                <button onClick={handleSubmit} class="bg-purple-500 w-full text-center text-white py-3">
                                    {loading ? <l-ring
                                        size="16"
                            ...
                            <div class="mt-5 text-center">
                                <p class="text-gray-500">Are you Admin? <Link to="/login" class="text-purple-500">Login as Admin</Link></p>
